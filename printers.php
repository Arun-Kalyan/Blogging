...
--->
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-card-4 w3-bar-block">
        <a href="billrolls.php" class="w3-bar-item w3-button">Billrolls</a>
        <a href="printers.php" class="w3-bar-item w3-button">Printers</a>
    ...
    <div class="row">
        ...
        <div class="col-md-3">                				
            ...
            <div class="list-group">
                ...
                $query = "SELECT DISTINCT(dpi) FROM printers WHERE brand_status = '1' ORDER BY dpi ";
                ...
                <div class="list-group-item checkbox">
                    <label><input type="checkbox" class="common_selector dpi" value="<?php echo $row['dpi']; ?>"  > <?php echo $row['dpi']; ?></label>
                </div>
                <?php
                }
            ...
            <div class="list-group">
                ...
                $query = "SELECT DISTINCT(max_speed) FROM printers WHERE brand_status = '1' ORDER BY max_speed ";
                $statement = $connect->prepare($query);
                $statement->execute();
                $result = $statement->fetchAll();
                foreach($result as $row)
                ...
                ?>
                <div class="list-group-item checkbox">
                    <label><input type="checkbox" class="common_selector max_speed" value="<?php echo $row['max_speed']; ?>"  > <?php echo $row['max_speed']; ?></label>
                </div>
                <?php
                }
            ...
            <div class="list-group">
                ...
                $query = "SELECT DISTINCT(type) FROM printers WHERE brand_status = '1' ORDER BY  type";
                $statement = $connect->prepare($query);
                $statement->execute();
                $result = $statement->fetchAll();
                foreach($result as $row)
...
$(document).ready(function(){
    ...
    function filter_data()
    {
        ...
        var dpi = get_filter('dpi');
        var max_speed = get_filter('max_speed');
        var type= get_filter('type');
        
    
        $.ajax({
            url:"printers_fetch_data.php",
            method:"POST",
            data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, dpi:dpi, max_speed:max_speed, type:type},
